...
namespace MariaCositas.Controllers
{
    public class TipoServiciosController : Controller
    {
        ...
        public TipoServiciosController(MariacositasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdTipoServicio,Prenda,Arreglo,Valor")] TipoServicio tipoServicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTipoServicio,Prenda,Arreglo,Valor")] TipoServicio tipoServicio)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MariacositasContext.TipoServicios'  is null.");
            }
            var tipoServicio = await _context.TipoServicios.FindAsync(id);
            if (tipoServicio != null)
            {
